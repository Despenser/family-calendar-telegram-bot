...
- [x] 15.2 Разделить EventCallbackHandler (1225 строк, 9 зависимостей, 19 методов)
...
- [x] 15.3 Разделить AttachmentCallbackHandler (1341 строк, 7 зависимостей, 16 методов)
...
- [x] 15.4 Разделить MyEventsCommandHandler (1024 строк, 6 зависимостей, 17 методов)
