...
- [ ] 1. Инициализация проекта и Docker инфраструктура
...
- [ ] 1.5 Создать конфигурационные файлы
...
- [ ] 2.1 Создать Flyway миграции для схемы БД
...
- [ ] 2.4 Написать integration тест для миграций
  - Использовать Testcontainers для PostgreSQL
  - Проверить, что все миграции применяются успешно
  - Проверить создание таблиц и индексов
  - _Requirements: 11.1, 11.5_

- [ ] 3. Реализация конфигурации и Webhook
- [ ] 3.1 Создать BotConfig класс
...
- [ ] 3.2 Создать Webhook регистрацию при старте
...
- [ ] 3.3 Создать Webhook REST Controller
...
- [ ] 3.4 Написать unit тест для валидации конфигурации
...
- [ ] 4. Реализация User Service и авторизации
- [ ] 4.1 Создать UserService
...
- [ ] 4.2 Написать unit тесты для UserService
...
- [ ] 4.3 Написать integration тест для UserService
  - Использовать Testcontainers для PostgreSQL
  - Тест создания пользователя и поиска по Telegram ID
  - Проверить сохранение в БД
  - _Requirements: 3.4_

- [ ] 5. Реализация Event Service
- [ ] 5.1 Создать EventService
...
- [ ] 5.2 Написать unit тесты для EventService
...
- [ ] 5.3 Написать integration тест для EventService
  - Использовать Testcontainers
  - Тест полного цикла: создание, получение, обновление, удаление события
  - Проверить сохранение в БД и связи с User и Family
  - _Requirements: 4.3, 5.1_

- [ ] 6. Реализация Command Handler инфраструктуры
- [ ] 6.1 Создать интерфейс CommandHandler
  - Определить методы: handle(Message, User), getCommand(), getDescription(), requiresAuth()
  - Добавить Javadoc комментарии
  - _Requirements: 1.2_

- [ ] 6.2 Создать CommandDispatcher
...
- [ ] 6.4 Написать unit тесты для CommandDispatcher
  - Тест регистрации обработчиков
  - Тест маршрутизации к правильному handler
  - Тест проверки авторизации
  - _Requirements: 1.2_

- [ ] 7. Реализация базовых Command Handlers
- [ ] 7.1 Реализовать StartCommandHandler
...
- [ ] 7.2 Реализовать HelpCommandHandler
  - Аннотировать @Component
...
- [ ] 7.3 Написать unit тесты для базовых handlers
...
- [ ] 8. Реализация Event Command Handlers
- [ ] 8.1 Реализовать AddEventCommandHandler
  - Аннотировать @Component
...
- [ ] 8.2 Реализовать UpcomingEventsCommandHandler
  - Аннотировать @Component
...
- [ ] 8.3 Реализовать MyEventsCommandHandler
  - Аннотировать @Component
...
- [ ] 8.4 Написать unit тесты для Event handlers
...
- [ ] 9.1 Создать NotificationService
  - Аннотировать @Service
...
- [ ] 9.2 Создать TelegramMessageService
  - Аннотировать @Service
...
- [ ] 9.3 Написать unit тесты для NotificationService
...
- [ ] 9.4 Написать integration тест для уведомлений
  - Использовать Testcontainers
  - Создать событие, которое начнется через 1 час
  - Запустить scheduled метод вручную
  - Проверить, что событие отмечено как notified
  - _Requirements: 6.1, 6.3_

- [ ] 10. Реализация обработки ошибок
- [ ] 10.1 Создать пользовательские исключения
...
- [ ] 10.2 Создать GlobalExceptionHandler
...
- [ ] 10.3 Написать unit тесты для GlobalExceptionHandler
...
- [ ] 11.2 Создать скрипты для управления
...
- [ ] 12.2 Создать SETUP.md с инструкциями
...
- [ ] 12.3 Добавить Javadoc комментарии
...
- [ ] 13. Integration тесты end-to-end
- [ ] 13.1 Написать E2E тест для создания события
  - Использовать Testcontainers
  - Создать пользователя и семью в БД
  - Симулировать команду /add_event
  - Проверить создание события в БД
  - Проверить отправку подтверждения
  - _Requirements: 4.1, 4.3_

- [ ] 13.2 Написать E2E тест для просмотра событий
  - Создать несколько событий в БД
  - Симулировать команду /upcoming_events
  - Проверить формат ответа
  - Проверить сортировку событий
  - _Requirements: 5.1, 5.4_

- [ ] 13.3 Написать E2E тест для редактирования события
  - Создать событие
  - Симулировать команду /my_events
  - Симулировать callback для редактирования
  - Проверить обновление в БД
  - _Requirements: 7.1, 7.4_

- [ ] 13.4 Написать E2E тест для уведомлений
  - Создать событие через 1 час
  - Запустить NotificationService вручную
  - Проверить отправку уведомлений
  - Проверить отметку notified в БД
  - _Requirements: 6.1, 6.3_

- [ ] 14. Финальная проверка
- [ ] 14.1 Запустить все тесты
  - Запустить все unit тесты
  - Запустить все integration тесты
  - Проверить покрытие кода (цель > 70%)
  - Исправить failing тесты

- [ ] 14.2 Проверить Docker Compose
  - Выполнить полный цикл: build, up, test, down
  - Проверить персистентность данных после перезапуска
  - Проверить логи на наличие ошибок
  - _Requirements: 10.1, 10.4_

- [ ] 14.3 Проверить документацию
