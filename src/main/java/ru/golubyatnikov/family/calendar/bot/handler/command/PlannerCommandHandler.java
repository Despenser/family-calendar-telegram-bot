 ...
 * <ul>
 *   <li>{@link PlannerQueryService} - получение данных о событиях</li>
 *   <li>{@link PlannerFormattingService} - форматирование сообщений</li>
 *   <li>{@link PlannerNavigationService} - навигация и отправка сообщений</li>
 * </ul>
 * 
 * @see CommandHandler
 * @see PlannerQueryService
 * @see PlannerFormattingService
 * @see PlannerNavigationService
