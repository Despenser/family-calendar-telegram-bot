 ...
 * 
 * <p>Обрабатывает текстовое сообщение пользователя как поисковый запрос
 * и делегирует выполнение поиска в SearchCommandHandler.</p>
 * 
...
public class SearchQueryMessageHandler {
    ...
    public void handle(Message message, User user) {
        try {
            ...
            // Делегируем выполнение поиска в SearchCommandHandler
            // Контекст будет очищен в performSearch после редактирования
