...
public class DraftCleanupConfig {
    ...
    /**
     * Включить/выключить автоматическую очистку черновиков (по умолчанию: true)
     */
    private boolean enabled = true;

    /**
     * Пороговое значение для очистки при запуске приложения в часах (по умолчанию: 1)
     */
    private int startupThresholdHours = 1;

    /**
     * Пороговое значение для периодической очистки в часах (по умолчанию: 24)
     */
